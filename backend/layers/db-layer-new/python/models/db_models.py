...
class TakeTest(Base):
    ...
    user = relationship('User', backref=backref("test_assoc"))
    course = relationship('Test', backref=backref("user_assoc"))
...
class DoAssignment(Base):
    ...
    user = relationship('User', backref=backref('assignment_assoc'))
    assignment = relationship('Assignment', backref=backref('user_assoc'))
...
class Assignment(Base):
    ...
    do_assignment = relationship('User', secondary='do_assignment')
...
class Test(Base):
    ...
    course_id = Column('course_id', ForeignKey('courses.id'))
    users = relationship('User', secondary='take_test')
...
class User(Base):
    ...
    do_assignment = relationship('Assignment', secondary='do_assignment')
